...
export default function Adopt() {
  ...
  const GetPetsData = async () => {
    ...
    let petAdsResponse = await fetch('http://localhost:5000/api/postAd/fetchallpost',{
    ...
    let featuredPetsResponse = await fetch('http://localhost:5000/api/rescue/fetchallrescue',{
  ...
  return (
    <div style={{display:'flex',margin:'30px 40px'}}>
        ...
        <div style={{display:'flex', flexWrap:'wrap', justifyContent:'space-between' , gap:'7px', width:'80%' ,margin:'0 0 0 20px' ,padding:'20px' , borderRadius:'15px',border:'1.5px solid #B66089'}}>
